...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props, { slots }) {
        ...
        function updateSegmentPosition({ disabledTransition }) {
            ...
            if (activeTabEl && segmentCapsuleElRef.value) {
                ...
                segmentCapsuleElRef.value.style.transform = `translateX(${rect.left -
                    tabsEl.getBoundingClientRect().left -
                    (0, seemly_1.depx)(getComputedStyle(tabsEl).paddingLeft)}px)`;
            }
    ...
    render() {
        ...
        return ((0, vue_1.h)("div", { class: [
            ...
            (0, vue_1.h)("div", { class: [
                ...
                isSegment ? ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-tabs-rail`, ref: "tabsElRef" },
