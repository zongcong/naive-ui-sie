...
export declare const calendarProps: {
    ...
    readonly theme: PropType<import("../../_mixins").Theme<"Calendar", {
        borderRadius: string;
        borderColor: string;
    ...
    readonly themeOverrides: PropType<import("../../_mixins/use-theme").ExtractThemeOverrides<import("../../_mixins").Theme<"Calendar", {
        borderRadius: string;
        borderColor: string;
        borderColorModal: string;
        borderColorPopover: string;
    ...
    readonly builtinThemeOverrides: PropType<import("../../_mixins/use-theme").ExtractThemeOverrides<import("../../_mixins").Theme<"Calendar", {
        borderRadius: string;
        borderColor: string;
        borderColorModal: string;
        borderColorPopover: string;
...
declare const _default: import("vue").DefineComponent<{
    ...
    dateLocale: import("vue").Ref<import("../../locales/date/enUS").NDateLocale>;
    now: number;
    mergedValue: import("vue").ComputedRef<number | null>;
    monthTs: import("vue").Ref<number>;
    dateItems: import("vue").ComputedRef<import("../../date-picker/src/utils").DateItem[]>;
    doUpdateValue: (value: number, time: DateItem) => void;
