    ...
    render() {
        ...
        const createYRail = (className, style) => {
            return ((0, vue_1.h)("div", { ref: "yRailRef", class: [
                    ...
                    className
                ], "data-scrollbar-rail": true, style: [style || '', this.verticalRailStyle], "aria-hiddens": true }, (0, vue_1.h)(
            // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
            (triggerIsNone ? _utils_1.Wrapper : vue_1.Transition), triggerIsNone ? null : { name: 'fade-in-transition' }, {
        ...
        const createChildren = () => {
            ...
            return (0, vue_1.h)('div', (0, vue_1.mergeProps)(this.$attrs, {
                ...
                this.xScrollable && ((0, vue_1.h)("div", { ref: "xRailRef", class: [
                    ...
                    ], style: this.horizontalRailStyle, "data-scrollbar-rail": true, "aria-hidden": true }, (0, vue_1.h)(
                // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
                (triggerIsNone ? _utils_1.Wrapper : vue_1.Transition), triggerIsNone ? null : { name: 'fade-in-transition' }, {
